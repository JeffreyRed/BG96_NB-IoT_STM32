...
void BG96_Cumulocity(){	
	...
	//just to check the connecivity
			if (BG96_Check_Internet()==1){
			HAL_UART_Transmit(&huart2,"The internet service is OK.\r\n",sizeof("The internet service is OK.\r\n"),1000);
			HAL_Delay(200);
			}else {
...
int BG96_Check_Internet(){
	...
	HAL_Delay(8000); // waiting 10 sec to received the ping responses.
